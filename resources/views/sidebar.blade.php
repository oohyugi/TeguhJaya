    ...
    <section class="sidebar">
     ...
     <!--  <form action="#" method="get" class="sidebar-form">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="{{url('admin/gudang')}} "><i class="fa fa-list-alt"></i> <span>Barang Gudang</span></a></li>
      ...
      @if( Auth::user()->jabatan == 'Super Admin')
        ...
        <li class="active"> <a href="{{url('admin/karyawan')}}"> <i class="fa fa-users" aria-hidden="true"></i>
